...
interface ReleaseCubeRadiantProps {
  variant?: "song" | "album";
  title: string;
  href: string;
...
export function ReleaseCubeRadiant({ variant = "song", title, href, coverArtPath, planeThreeVideo, chorus, tracklist, conceptStatement, cardFocalX, cardFocalY, cardZoom }: ReleaseCubeRadiantProps) {
