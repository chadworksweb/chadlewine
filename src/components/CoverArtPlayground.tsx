...
export function CoverArtPlayground({ src, alt, className, focalX = 0.5, focalY = 0.5 }: ArtPlaygroundProps) {
  ...
  return (
    <div className="art-playground">
      <div className="art-playground__canvas" style={{ position: "relative" }}>
        <div style={mode === "ripple" ? show : hide}><WaterRipple src={src} alt={alt} className={className} focalX={focalX} focalY={focalY} /></div>
        <div style={mode === "lightning" ? show : hide}><LightningEffect src={src} alt={alt} className={className} focalX={focalX} focalY={focalY} /></div>
        <div style={mode === "glitch" ? show : hide}><GlitchEffect src={src} alt={alt} className={className} focalX={focalX} focalY={focalY} /></div>
        <div style={mode === "kaleidoscope" ? show : hide}><KaleidoscopeEffect src={src} alt={alt} className={className} focalX={focalX} focalY={focalY} /></div>
        <div style={mode === "shatter" ? show : hide}><ShatterEffect src={src} alt={alt} className={className} focalX={focalX} focalY={focalY} /></div>
        <div style={mode === "invert" ? show : hide}><InvertWaveEffect src={src} alt={alt} className={className} focalX={focalX} focalY={focalY} /></div>
      </div>
