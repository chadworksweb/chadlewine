...
export const metadata: Metadata = {
  ...
  // Every file below is generated by design/favicon/build.mjs from
  // design/favicon/params.json. Do not edit the binaries; change a number and
  // re-run the build. The SVG is listed first so a browser that can take it
  // never falls back to a raster.
  icons: {
    icon: [
