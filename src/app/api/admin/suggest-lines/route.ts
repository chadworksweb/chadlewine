...
For "hook" field: Find 3-5 sentences that are the most provocative — the line that stops someone mid-scroll, becomes the Hook fragment. Selection criteria: standalone impact, extractability, surprise, quotability, works as a meta description fallback.
