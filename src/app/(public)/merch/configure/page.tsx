...
export const metadata: Metadata = {
  ...
  description:
    "Pick any art or line from a Song. Put it on a Comfort Colors 1717.",
    ...
    <div id="page-merch-configure" className="page-merch">
      <header className="page-merch__header">
        ...
        <p className="page-merch__subtitle">
          Pick any art or line from a Song. Put it on a Comfort Colors 1717.
          If it&rsquo;s good, submit it for the permanent catalog &mdash; and
          earn revenue share on every future sale.
        </p>
      </header>
