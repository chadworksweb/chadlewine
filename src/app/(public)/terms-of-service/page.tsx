...
const sections: LegalSection[] = [
  ...
  {
    id: "digital-downloads-and-license",
    title: "Digital Downloads and License",
    content: (
      <>
        <p>
  ...
  {
    id: "physical-merchandise-and-shipping",
    title: "Physical Merchandise and Shipping",
    content: (
      <>
        <p>
  ...
  {
    id: "patronage-contributions",
    title: "Patronage Contributions",
    content: (
      <p>
  ...
  {
    id: "refunds-returns-and-exchanges",
  ...
  },
  {
    ...
    content: (
      <>
        <p>We send two categories of email:</p>
        <p>
  ...
  {
    id: "account-termination-and-deletion",
