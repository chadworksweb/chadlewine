...
const ITEMS = [
  { href: "/admin/merch/orders", label: "Orders", blurb: "Customer orders, fulfillment, tracking." },
  { href: "/admin/cart-recovery", label: "Cart Recovery", blurb: "Abandoned-cart recovery emails." },
];
  ...
  return (
    <div className="admin-page">
      <div className="admin-page__header">
        <h1 className="admin-page__title">Ecom</h1>
      </div>
